      ...
      <div className="how-we-started-about">
        <div className="how-we-started-text">
          <div className='texts texts1'>
            GYWS started iwth the vision to give back to society by helping in uplifting the less fortunate . When he came across a few IITians who wanted to volunteer for a good cause but lacked the right platform- Gopali Youth Welfare Society came into being.
          </div>
          <div className='texts' >
